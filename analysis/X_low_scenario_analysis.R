...
low_roi_undiscextrawelfarist <- extrawelfarist_undiscsum_low %>%
  mutate(roi_low = ((total_low - (dev_funding + del_cost + apa + corporate_low + manu))/(dev_funding + del_cost + apa + corporate_low + manu)),
         roi_med = ((total_med - (dev_funding + del_cost + apa + corporate_low + manu))/(dev_funding + del_cost + apa + corporate_low + manu)),
         roi_high = ((total_high - (dev_funding + del_cost + apa + corporate_low + manu))/(dev_funding + del_cost + apa + corporate_low + manu))) %>%
